...
export const TableEmpty = ({ children = "暂无数据" }: { children?: React.ReactNode }) => (
  <div className="flex h-40 items-center justify-center text-sm text-muted-foreground">{children}</div>
);
